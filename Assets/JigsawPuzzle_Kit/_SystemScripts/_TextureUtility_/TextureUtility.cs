...
public static class TextureUtility
{
    ...
    //-----------------------------------------------------------------------------------------------------
    // Load texturefrom external source
    ...
    public static Texture2D LoadTexture(string _path, int _width = 1, int _height = 1)
    {
        Texture2D texture;
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------------------- 
    // Create new Texture2D filled by custom color
    public static Texture2D CreateTexture(int _width, int _height, Color _color)
    {
        ...
        resultPixels = CreatePixelArray(_width, _height, _color);
    ...
    {
        Color[] resultPixels = new Color[_width * _height];
        int pixelLength = resultPixels.Length;
